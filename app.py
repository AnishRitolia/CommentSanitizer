...
hide_st_style = """
            ...
            .stTextInput input {border: 1px solid #ccc; padding: 10px; border-radius: 5px;}
            .stTextArea textarea {border: 1px solid #ccc; padding: 10px; border-radius: 5px;}
            .lofi-music {position: absolute; bottom: 10px; right: 10px;}
            </style>
            """
# Inject the CSS code
st.markdown(hide_st_style, unsafe_allow_html=True)
...
if selected == "Home":
    ...
    **Key Features:**
    ...
    st.markdown("""
        <div class="lofi-music">
            <iframe width="300" height="150" src="https://www.youtube.com/embed/5qap5aO4i9A" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
        </div>
    ...
    if st.button("Sanitize Comment"):
        if text_input:
            ...
            if result == "Harmful":
                st.markdown("""
                    <div class="lofi-music">
                        <iframe width="300" height="150" src="https://www.youtube.com/embed/SZQz9tkEHIg" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                    </div>
                    """, unsafe_allow_html=True)
            else:
                st.markdown("""
                    <div class="lofi-music">
                        <iframe width="300" height="150" src="https://www.youtube.com/embed/5yx6BWlEVcY" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                    </div>
                    """, unsafe_allow_html=True)
...
if selected == "FAQ":
    ...
    ### What types of comments can it analyze?
    Comment Sanitizer can analyze any type of text comment. It is designed to detect harmful content, including offensive language, threats, and other inappropriate content.

    ### Can I upload a file with multiple comments?
    Yes, you can upload a CSV file containing multiple comments. Comment Sanitizer will process each comment and provide a classification for each one.

    ### How accurate is the model?
    The accuracy of the model depends on the quality of the training data and the specific use case. While it is generally effective at detecting harmful content, no automated system is perfect. It is always recommended to review the results manually.

    ### How can I contact the developers?
    You can reach out to the developers, Aastha Mahato and Anish Ritolia, through the Contact Us page for any further questions or inquiries.

    """
    
    st.markdown(faq_content)

    # Adding lofi music related to FAQ content
    st.markdown("""
        <div class="lofi-music">
            <iframe width="300" height="150" src="https://www.youtube.com/embed/e3L1PIY1pN8" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
        </div>
        """, unsafe_allow_html=True)
...
if selected == "Contact":
    ...
    # Adding a good graphic
    st.markdown("""
        <div style="text-align: center;">
            <img src="https://cdn.pixabay.com/photo/2017/01/31/13/14/handshake-2022484_960_720.png" width="300" alt="Contact Us">
        </div>
        """, unsafe_allow_html=True)
